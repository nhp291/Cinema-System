...
export const movies = [
  ...
  export const news = [
    { 
      id: 1, 
      title: 'New Movie Releases for January 2025', 
      description: 'Check out the latest movies hitting the theaters in January 2025, including action-packed thrillers and heartwarming romances!', 
      date: '2025-01-01', 
      author: 'Movie News Team', 
      image_url: 'https://iguov8nhvyobj.vcdn.cloud/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/3/5/350x495-badgenius.jpg' 
    },
    { 
      id: 2, 
      title: 'Top 5 Must-Watch Movies in February 2025', 
      content: 'February brings exciting new releases, including the highly anticipated "Captain America: New World." Don\'t miss out on these top picks!', 
      date: '2025-01-15', 
      author: 'Movie Critics', 
      image_url: 'https://iguov8nhvyobj.vcdn.cloud/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/s/t/sth3_poster_470x700.jpg' 
    },
    { 
      id: 3, 
      title: 'Behind the Scenes: Making of "Lembayung: Oan Hồn Sản Phụ"', 
      content: 'Get an exclusive look at the making of the horror thriller "Lembayung," with insights from the director and cast on how they brought the terrifying story to life.', 
      date: '2025-01-10', 
      author: 'Film Production Team', 
      image_url: 'https://iguov8nhvyobj.vcdn.cloud/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/3/5/350x495lembayung.jpg' 
    },
    { 
      id: 4, 
      title: 'Top 10 Family-Friendly Movies to Watch This Winter', 
      content: 'Winter is the perfect time to watch family-friendly movies. Check out our list of 10 films that the whole family will enjoy, from animated adventures to heartwarming stories.', 
      date: '2025-01-20', 
      author: 'Family Film Experts', 
      image_url: 'https://iguov8nhvyobj.vcdn.cloud/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/h/p/hpg_poster_470x700.jpg' 
    },
    { 
      id: 5, 
      title: 'The Evolution of the Marvel Cinematic Universe', 
      content: 'As the MCU continues to expand, we explore how the franchise has evolved over the years and what’s next for its beloved characters, including the new Captain America!', 
      date: '2025-01-18', 
      author: 'Superhero Cinema Fans', 
      image_url: 'https://iguov8nhvyobj.vcdn.cloud/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/c/a/captain_america_th_gi_i_m_i_-_official_poster.jpg' 
    }
  ];
